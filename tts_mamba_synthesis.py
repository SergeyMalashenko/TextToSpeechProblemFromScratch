...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out_dir", type=str, default=None, help="Output directory. Defaults to outputs/synthesis/mamba_<backend>.")
    ...
    if args.out_dir is None:
        ...
        args.out_dir = str(synthesis_root / f"mamba_{args.backend}")
    return args
